...
exports.LANGUAGE_TEST_CASES = void 0;
exports.getTestCases = getTestCases;
exports.getTestCasesByCategory = getTestCasesByCategory;
exports.getBasicTests = getBasicTests;
exports.getErrorTests = getErrorTests;
exports.getSupportedLanguages = getSupportedLanguages;
exports.LANGUAGE_TEST_CASES = {
    javascript: [
        {
            id: 'js-basic-1',
            name: 'Hello World',
...
function getTestCases(language) {
    return exports.LANGUAGE_TEST_CASES[language] || [];
}
function getTestCasesByCategory(language, category) {
    const allTests = getTestCases(language);
    return allTests.filter(test => test.category === category);
}
function getBasicTests(language) {
    return getTestCasesByCategory(language, 'basic');
}
function getErrorTests(language) {
    return getTestCasesByCategory(language, 'error');
}
function getSupportedLanguages() {
    return Object.keys(exports.LANGUAGE_TEST_CASES);
}
